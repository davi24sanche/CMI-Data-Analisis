<%@ Page Title="" Language="C#" MasterPageFile="~/Web/Menu.Master" AutoEventWireup="true" CodeBehind="VerAmortizacion.aspx.cs" Inherits="UI.Web.VerAmortizacion" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="Large" Text="Detalle Amortización - Contrato NIFF"></asp:Label>
    <br />
    <br />
    ...
    <asp:SqlDataSource ID="DS_Amortizacion_Contrato" runat="server" ConnectionString="Data Source=10.144.10.100;Initial Catalog=PORTAL;Persist Security Info=True;User ID=sa
;Password=SAsoftladbqa$" ProviderName="System.Data.SqlClient" SelectCommand="PORTAL.[dbo].[PORTAL_AMORTIZACION_CONTRATO]" SelectCommandType="StoredProcedure">
        <SelectParameters>
            <asp:SessionParameter DefaultValue="0" Name="CONTRATO_ID" SessionField="ContratoAmortizacion" Type="Int32" />
        </SelectParameters>
    </asp:SqlDataSource>
...
order by 2">
    ...
    <dx:ASPxGridView ID="grid_data"  ClientInstanceName="grid" runat="server" Width="1324px" AutoGenerateColumns="False" DataSourceID="DS_Amortizacion_Contrato" Theme="SoftOrange" KeyFieldName="ID" EnableRowsCache="False" >
        ...
        <Columns>
            ...
            <dx:GridViewDataTextColumn FieldName="VALOR_CUOTA" VisibleIndex="4" ShowInCustomizationForm="True" Caption="Valor Cuota">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn FieldName="INTERES" VisibleIndex="5" ShowInCustomizationForm="True" Caption="Interés">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn FieldName="AMORTIZACION" VisibleIndex="6" ShowInCustomizationForm="True" Caption="Amortización">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn FieldName="SALDO" VisibleIndex="7" ShowInCustomizationForm="True" Caption="Saldo">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn FieldName="ESTADO_DESCRIPCION" VisibleIndex="8" ShowInCustomizationForm="True" Caption="Estado">
            </dx:GridViewDataTextColumn>
            <dx:GridViewCommandColumn ShowSelectCheckbox="True" VisibleIndex="9" ShowClearFilterButton="True">
