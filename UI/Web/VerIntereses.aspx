<%@ Page Title="" Language="C#" MasterPageFile="~/Web/Menu.Master" AutoEventWireup="true" CodeBehind="VerIntereses.aspx.cs" Inherits="UI.Web.VerIntereses" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="Large" Text="Detalle Interéses - Contrato NIFF"></asp:Label>
    <br />
    <br />
    ...
    <asp:SqlDataSource ID="DS_Intereses_Contrato" runat="server" ConnectionString="Data Source=10.144.10.100;Initial Catalog=PORTAL;Persist Security Info=True;User ID=sa
;Password=SAsoftladbqa$" ProviderName="System.Data.SqlClient" SelectCommand="PORTAL.[dbo].[PORTAL_INTERESES_CONTRATO]" SelectCommandType="StoredProcedure">
        <SelectParameters>
            <asp:SessionParameter DefaultValue="0" Name="CONTRATO_ID" SessionField="ContratoIntereses" Type="Int32" />
        </SelectParameters>
    </asp:SqlDataSource>
...
order by 2">
    ...
    <dx:ASPxGridView ID="grid_data"  ClientInstanceName="grid" runat="server" Width="1324px" AutoGenerateColumns="False" DataSourceID="DS_Intereses_Contrato" Theme="SoftOrange" KeyFieldName="ID" EnableRowsCache="False" >
        ...
        <Columns>
            ...
            <dx:GridViewDataTextColumn FieldName="GASTO_INTERES" VisibleIndex="3" ShowInCustomizationForm="True" Caption="Gasto Intéres">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn FieldName="GASTO_DEPRECIACION" VisibleIndex="4" ShowInCustomizationForm="True" Caption="Gasto Depreciación">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn FieldName="TOTAL_GASTO" VisibleIndex="5" ShowInCustomizationForm="True" Caption="Total Gasto">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn FieldName="GASTO_ALQUILER" VisibleIndex="6" ShowInCustomizationForm="True" Caption="Gasto Alquiler">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn FieldName="MEJOR_UTILIDAD" VisibleIndex="7" ShowInCustomizationForm="True" Caption="Mejor Utilidad">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn FieldName="TIPO" VisibleIndex="8" ShowInCustomizationForm="True" Caption="Tipo">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn FieldName="ESTADO_DESCRIPCION" VisibleIndex="9" ShowInCustomizationForm="True" Caption="Estado">
            </dx:GridViewDataTextColumn>
            <dx:GridViewCommandColumn ShowSelectCheckbox="True" VisibleIndex="10" ShowClearFilterButton="True">
