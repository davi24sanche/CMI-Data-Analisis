<%@ Page Title="" Language="C#" MasterPageFile="~/Web/Menu.Master" AutoEventWireup="true" CodeBehind="NuevoContratoNIFF.aspx.cs" Inherits="UI.Web.NuevoContratoNIFF" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <dx:ASPxFormLayout ID="FormLayout" ClientInstanceName="FormLayout" runat="server" RequiredMarkDisplayMode="Auto" UseDefaultPaddings="false" AlignItemCaptionsInAllGroups="true" Width="100%" ColumnCount="2">
        ...
        <Items>
            <dx:LayoutGroup Caption="Nuevo Contrato NIFF" GroupBoxDecoration="Box" ColumnCount="1">
...
<Paddings Padding="0px"></Paddings>
                    ...
                    <dx:LayoutItem Caption="Periocidad del Aumento al Pago Mínimo" Name="LiPerioricidadPagoMinimo">
                        <LayoutItemNestedControlCollection>
                            <dx:LayoutItemNestedControlContainer>
                                <dx:ASPxSpinEdit ID="txtPeriocidadAumentoPagoMinimo" runat="server" Number="00.00" DisplayFormatString="{0:C}" Width="100%" CssClass="maxWidth" NumberType="Integer" />
