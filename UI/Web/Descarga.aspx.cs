    ...
    public partial class Descarga : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (Request.Params["id"] != null)
            {
                ...
                string valor = Request.Params["id"].ToString();
                ...
                FileStream stream = new FileStream(this.Server.MapPath("~/SecureFolder/" + "Anexo NIFF 16.xlsx"), FileMode.Create, FileAccess.ReadWrite, FileShare.ReadWrite);
                //FileStream stream = new FileStream(this.Server.MapPath("Anexo NIFF 16.xlsx"), FileMode.Create, FileAccess.ReadWrite);
                ...
                using (IXlRow row = sheet.CreateRow())
                {
                    ...
                    using (IXlCell cell = row.CreateCell())
                    {
                        ...
                        cell.Value = Double.Parse(resultado.ToString());
                    }
                    using (IXlCell cell = row.CreateCell())
                    {
                        cell.Value = "Años";
                ...
                using (IXlRow row = sheet.CreateRow())
                {
                    ...
                    using (IXlCell cell = row.CreateCell())
                    {
                        cell.Value = Double.Parse(oContrato.CuotaArrendamiento.ToString());
                    }
                    using (IXlCell cell = row.CreateCell())
                    {
                        cell.Value = "";
                ...
                using (IXlRow row = sheet.CreateRow())
                {
                    ...
                    using (IXlCell cell = row.CreateCell())
                    {
                        XlCellFormatting formatoPorcentaje = new XlCellFormatting();
                        formatoPorcentaje.NumberFormat = XlNumberFormat.Percentage2;

                        //double valorTasa = Double.Parse(oContrato.TasaAnual.ToString());
                        double valorTasa = Double.Parse(oContrato.TasaDescuento.ToString());
                        cell.Formatting = XlNumberFormat.Percentage2;
                        cell.Value = valorTasa;
                        cell.ApplyFormatting(formatoPorcentaje);
                        //"0.0%"
                    }
                    fila = fila + 1;
                }
                ...
                using (IXlRow row = sheet.CreateRow())
                {
                    ...
                    using (IXlCell cell = row.CreateCell())
                    {
                        cell.Value = Double.Parse(oContrato.PerioricidadCuota.ToString());
                    }
                    fila = fila + 1;
                }
                ...
                using (IXlRow row = sheet.CreateRow())
                {
                    ...
                    using (IXlCell cell = row.CreateCell())
                    {
                        XlCellFormatting formatoPorcentaje2 = new XlCellFormatting();
                        formatoPorcentaje2.NumberFormat = XlNumberFormat.Percentage2;
                        //double tasaImplicita = Double.Parse((oContrato.TasaAnual / oContrato.PerioricidadCuota).ToString());
                        double tasaImplicita = Double.Parse((oContrato.TasaDescuento / oContrato.PerioricidadCuota).ToString());
                        cell.Value = tasaImplicita;
                        cell.ApplyFormatting(formatoPorcentaje2);
                    }
                    fila = fila + 1;
                }
                ...
                foreach (CuotaAnual item in lstCuotas)
                {
                    using (IXlRow row = sheet.CreateRow())
                    {
                        ...
                        using (IXlCell cell = row.CreateCell())
                        {
                            cell.Value = Double.Parse(item.MontoCuotaAnual.ToString());
                        }
                        using (IXlCell cell = row.CreateCell())
                        {
                            cell.Value = Double.Parse(item.PrimerTramo.ToString());
                        }
                        using (IXlCell cell = row.CreateCell())
                        {
                            cell.Value = "";
                        ...
                        using (IXlCell cell = row.CreateCell())
                        {
                            cell.Value = Double.Parse(item.SegundoTramo.ToString());
                        }

                        using (IXlCell cell = row.CreateCell())
                        {
                            cell.Value = Double.Parse(item.CuotaAnualFinal.ToString());
                ...
                using (IXlRow row = sheet.CreateRow())
                {
                    ...
                    using (IXlCell cell = row.CreateCell())
                    {
                        cell.Value = Double.Parse(montoTotal.ToString());
                    }
                    fila = fila + 1;
                }
                ...
                foreach (Valor_Activo item in lstActivo)
                {
                    using (IXlRow row = sheet.CreateRow())
                    {
                        ...
                        using (IXlCell cell = row.CreateCell())
                        {
                            cell.Value = Double.Parse(item.CuotaAnual.ToString());
                        ...
                        using (IXlCell cell = row.CreateCell())
                        {
                            cell.Value = Double.Parse(item.ValorPresente.ToString());
                ...
                using (IXlRow row = sheet.CreateRow())
                {
                    ...
                    using (IXlCell cell = row.CreateCell())
                    {
                        cell.Value = Double.Parse(montoTotalCuotaAnual.ToString());
                        cell.ApplyFormatting(formatoNegrita);
                    }
                    using (IXlCell cell = row.CreateCell())
                    {
                    ...
                    using (IXlCell cell = row.CreateCell())
                    {
                        cell.Value = Double.Parse(montoTotalValorPresente.ToString());
                        cell.ApplyFormatting(formatoNegrita);
                    }
                    fila = fila + 1;
                }
                ...
                using (IXlRow row = sheet2.CreateRow())
                {
                    ...
                    using (IXlCell cell = row.CreateCell())
                    {
                        XlCellFormatting formatoPorcentaje3 = new XlCellFormatting();
                        formatoPorcentaje3.NumberFormat = XlNumberFormat.Percentage2;
                        //cell.Value = Double.Parse(oContrato.TasaAnual.ToString());
                        cell.Value = Double.Parse(oContrato.TasaDescuento.ToString());
                        cell.ApplyFormatting(formatoPorcentaje3);
                    }
                    fila = fila + 1;
                }
                ...
                using (IXlRow row = sheet2.CreateRow())
                {
                    ...
                    using (IXlCell cell = row.CreateCell())
                    {
                        //double tasaImplicita = Double.Parse((oContrato.TasaAnual / oContrato.PerioricidadCuota).ToString());
                        double tasaImplicita = Double.Parse((oContrato.TasaDescuento / oContrato.PerioricidadCuota).ToString());
                        XlCellFormatting formatoPorcentaje4 = new XlCellFormatting();
                        formatoPorcentaje4.NumberFormat = XlNumberFormat.Percentage2;
                        cell.Value = tasaImplicita;
                        cell.ApplyFormatting(formatoPorcentaje4);
                    }
                    fila = fila + 1;
                }
                ...
                foreach (Amortizacion item in lstAmortizacion)
                {
                    using (IXlRow row = sheet2.CreateRow())
                    {
                        ...
                        using (IXlCell cell = row.CreateCell())
                        {
                            cell.Value = Double.Parse(item.ValorCuota.ToString());
                            montoTotalCuota = montoTotalCuota + item.ValorCuota;
                        }
                        using (IXlCell cell = row.CreateCell())
                        {
                            cell.Value = Double.Parse(item.Interes.ToString());
                            montoTotalIntereses = montoTotalIntereses + item.Interes;
                        }
                        using (IXlCell cell = row.CreateCell())
                        {
                            cell.Value = Double.Parse(item.MontoAmortizacion.ToString());
                            montoTotalAmortizacion = montoTotalAmortizacion + item.MontoAmortizacion;
                        }
                        using (IXlCell cell = row.CreateCell())
                        {
                            cell.Value = Double.Parse(item.Saldo.ToString());
                        }
                        fila = fila + 1;
                    }
                }
                ...
                using (IXlRow row = sheet2.CreateRow())
                {
                    ...
                    using (IXlCell cell = row.CreateCell())
                    {
                        cell.Value = Double.Parse(montoTotalCuota.ToString());
                    }
                    using (IXlCell cell = row.CreateCell())
                    {
                        cell.Value = Double.Parse(montoTotalIntereses.ToString());
                    }
                    using (IXlCell cell = row.CreateCell())
                    {
                        cell.Value = Double.Parse(montoTotalAmortizacion.ToString());
                    }
                    fila = fila + 1;
                }
                ...
                foreach (Arrendamiento item in lstArrendamiento)
                {
                    using (IXlRow row = sheet2.CreateRow())
                    {
                        ...
                        using (IXlCell cell = row.CreateCell())
                        {
                            cell.Value = Double.Parse(item.GastoInteres.ToString());
                            montoGastoInteres = montoGastoInteres + item.GastoInteres;
                        }
                        using (IXlCell cell = row.CreateCell())
                        {
                            cell.Value = Double.Parse(item.GastoDepreciacion.ToString());
                            montoGastoDepreciacion = montoGastoDepreciacion + item.GastoDepreciacion;
                        }
                        using (IXlCell cell = row.CreateCell())
                        {
                            cell.Value = Double.Parse(item.TotalGasto.ToString());
                        ...
                        using (IXlCell cell = row.CreateCell())
                        {
                            cell.Value = Double.Parse(item.GastoAlquiler.ToString());
                            montoGastoAlquiler = montoGastoAlquiler + item.GastoAlquiler;
                        }
                        using (IXlCell cell = row.CreateCell())
                        {
                            cell.Value = Double.Parse(item.MejorUtilidad.ToString());
                ...
                using (IXlRow row = sheet2.CreateRow())
                {
                    ...
                    using (IXlCell cell = row.CreateCell())
                    {
                        cell.Value = Double.Parse(montoGastoInteres.ToString());
                    }
                    using (IXlCell cell = row.CreateCell())
                    {
                        cell.Value = Double.Parse(montoGastoDepreciacion.ToString());
                    }
                    using (IXlCell cell = row.CreateCell())
                    {
                        cell.Value = Double.Parse(montoTotalGasto.ToString());
                    }
                    using (IXlCell cell = row.CreateCell())
                    {
                        cell.Value = "";
                    ...
                    using (IXlCell cell = row.CreateCell())
                    {
                        cell.Value = Double.Parse(montoGastoAlquiler.ToString());
                    }
                    using (IXlCell cell = row.CreateCell())
                    {
                        cell.Value = Double.Parse(montoTotalUtilidad.ToString());
                    }
                    using (IXlCell cell = row.CreateCell())
                    {
                ...
                response.AddHeader("Content-Disposition",
                                   "attachment; filename=Anexo_NIFF_16.xlsx;");
                response.TransmitFile(Server.MapPath("~/SecureFolder/" + "Anexo NIFF 16.xlsx"));
                response.Flush();
                response.End();
            }
        }
