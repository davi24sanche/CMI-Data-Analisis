...
namespace UI.Web
{
    public partial class Planillapv2 : System.Web.UI.Page
    {
...
//                ((Lform.FindItemOrGroupByName("CiaOrigen") as LayoutItem).GetNestedControl() as ASPxGridLookup).Value = "";
        ...
        protected void ASPxFormLayout1_E3_ClickExc(object sender, EventArgs e)
        {
            ...
            WriteToResponse("ReportePlanilla.xlsx", true, "vnd.openxmlformats-officedocument.spreadsheetml.sheet", stream);
