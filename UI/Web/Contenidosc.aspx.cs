...
namespace UI.Web
{
    public partial class Contenidosc : System.Web.UI.Page
    {
        #region "Properties"
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!this.IsPostBack)
            {
                DashboardBootstrapper.SessionState = System.Web.SessionState.SessionStateBehavior.Required;
            ...
            ASPxDashboard1.DashboardId = "Dashboard";
        ...
        */
        ...
        protected void ASPxDashboard_ConfigureDataConnection(object sender, DevExpress.DashboardWeb.ConfigureDataConnectionWebEventArgs e)
        {
        ...
        // Carga el dashboard del objeto que está en la sesión "Dashboard", ya que este ultimo cambia con el menu (la vista)
        protected void ASPxDashboard1_DashboardLoading(object sender, DashboardLoadingWebEventArgs e)
        {
            try
            {
                ...
                e.DashboardXml = XDocument.Parse(dashboardDefinition);
            }
